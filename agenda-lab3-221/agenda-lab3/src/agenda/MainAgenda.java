...
public class MainAgenda {
	...
	/**
	 * Cadastra um contato da agenda na lista de favoritos.
	 * 
	 * @param agenda  A agenda.
	 * @param scanner Scanner para pedir a posição do contato a ser favoritado na
	 *                agenda e sua posição na lista de favoritos.
	 */
	...
	/**
	 * Remove um contato da agenda na lista de favoritos.
	 * 
	 * @param agenda  A agenda.
	 * @param scanner Scanner para pedir a posição do contato a ser removido.
	 */
	private static void removerFavorito(Agenda agenda, Scanner scanner) {
		System.out.print("\nPosição> ");
		int posicao = scanner.nextInt();
		agenda.removerDosFavoritos(posicao);
	}

	/**
	 * Imprime lista de contatos da agenda que estão na lista de favoritos.
	 * 
	 * @param agenda A agenda sendo manipulada.
	 */
	private static void listaFavoritos(Agenda agenda) {
		String[] contatos = agenda.getFavoritos();
		for (int i = 0; i < contatos.length; i++) {
			if (contatos[i] != null) {
				System.out.println(formataContato(i + 1, contatos[i]));
			}
